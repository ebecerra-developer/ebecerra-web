...
export function UsageWidget({ slug }: { slug: string }) {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const res = await fetch(`/admin/${slug}/api/chatbot/usage`);
  ...
  if (!usage) return <div className="admin-usage admin-usage--loading">Cargando…</div>;
    ...
    <div className="admin-usage">
      <div className="admin-usage__stats">
        <div className="admin-usage__stat">
          ...
          <span className="admin-usage__label">Conversaciones</span>
        </div>
        <div className="admin-usage__stat">
          ...
          <span className="admin-usage__label">Mensajes</span>
        </div>
        <div className="admin-usage__stat">
          <span className="admin-usage__num">{usage.tokens_total.toLocaleString("es-ES")}</span>
