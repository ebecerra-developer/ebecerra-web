...
- **[`apps/es`](apps/es/)** → `ebecerra.es` — modo pro, comercial para autónomos/PYMEs. Home con 6 secciones numeradas: 01 Servicios · 02 Sobre mí · 03 Capacidades (IA, reservas, integraciones, datos) · 04 Cómo trabajamos · 05 Ejemplos · 06 Contacto. Sección Servicios (singleton `servicesPricing`, revisada 2026-07-22, **IVA incluido**): dos formas — **cuota** (alta + mantenimiento anual, facturado 1 vez/año con 3 meses gratis; motivo fiscal: evita el alta de autónomo) y **pago único** (Landing/Portfolio/Web, la Tienda no). Planes: Landing (450 € + 22 €/mes · pago único 550 €) · Portfolio (590 € + 29 €/mes · 750 €) · Web (790 € + 69 €/mes · 1.150 €, el más contratado) · Tienda (1.190 € + 119 €/mes, solo cuota). Presentación en **flip cards** (gancho delante, detalle detrás). Diferenciación: Portfolio = enseñar tu obra (particulares); Web = vender tu negocio. Propiedad del código: web en la infra de Enrique; sin permanencia, código al cliente a los 12 meses (en pago único, desde el día 1). Add-ons: chatbot, reservas, generador social, SEO de zona, ficha Google, reseñas Google, blog. Migración 15 €/pág, 25 €/blog. Form de contacto con Resend. **Blog vivo desde 2026-05-15** (`/blog`).
...
- **[`apps/demos`](apps/demos/)** → `demos.ebecerra.es` — 6 demos publicadas (`fisio`, `coach-editorial`, `coach-vibrant`, `tandem`, `expedicion` inmersiva, `gestoria` híbrida home+subpáginas), plantilla propia cada una. Robots noindex global. Paletas y detalle por demo en memoria [project_demos_architecture](memory:project_demos_architecture).
