...
- **[`apps/es`](apps/es/)** → `ebecerra.es` — modo pro, comercial para autónomos/PYMEs. Home con 6 secciones numeradas: 01 Servicios · 02 Sobre mí · 03 Capacidades (IA, reservas, integraciones, datos) · 04 Cómo trabajamos · 05 Ejemplos · 06 Contacto. Sección Servicios reescrita 2026-07-11 (singleton `servicesPricing`): **modelo MRR único — alta + cuota mensual, sin pago único ni permanencia**. Cuatro planes: Landing (390 € + 19 €/mes) · Portfolio (490 € + 25 €/mes) · Web (690 € + 59 €/mes, el más contratado) · Tienda (990 € + 99 €/mes). Todo incluye hosting + mantenimiento + soporte en la cuota. Propiedad del código: la web vive en la infra de Enrique; sin permanencia, el código pasa al cliente a los 12 meses (antes se queda con él). Add-ons: chatbot, reservas, generador social, página SEO de zona, ficha Google Business, reseñas Google, blog. Footnote de migración (15 €/página, 25 €/blog entry). Form de contacto con Resend. **Blog vivo desde 2026-05-15** (`/blog`).
