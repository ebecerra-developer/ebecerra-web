...
const JOBS = [
  ...
  ...[1,2,3,4,5,6,7].map((n) => ({
    ...
    out:  `personal/2026/09/01-carrusel-vuelta-rutina/slide-${n}.png`,
    w: 1080, h: 1350,
  })),

  // ── 2026-09-02 · Post diferenciación "para qué la quieres" · 1080×1350 ──
  {
    html: `personal/2026/09/02-post-para-que-la-quieres/index.html`,
    out:  `personal/2026/09/02-post-para-que-la-quieres/final.png`,
    w: 1080, h: 1350,
  },
  ...
  // ── 2026-09-16 · Post humor "webs de los 2000" (nostalgia) · 1080×1350 ──
  {
    html: `personal/2026/09/16-post-webs-de-antes/index.html`,
    out:  `personal/2026/09/16-post-webs-de-antes/final.png`,
    w: 1080, h: 1350,
  },
  ...
  // ── 2026-09-27 · Post humor "la impresora huele el miedo" (distendido) · 1080×1350 ──
  {
    html: `personal/2026/09/27-post-impresora/index.html`,
    out:  `personal/2026/09/27-post-impresora/final.png`,
    w: 1080, h: 1350,
  },
  ...
  // ── 2026-07-08 · Carrusel "Anatomía de una home que convierte" · 8 slides 1080×1350 ──
  ...[1,2,3,4,5,6,7,8].map((n) => ({
    html: `personal/2026/07/08-carrusel-anatomia-home/slide-${n}.html`,
    out:  `personal/2026/07/08-carrusel-anatomia-home/slide-${n}.png`,
    w: 1080, h: 1350,
  })),
  ...
  // ── 2026-07-29 · Post curiosidad "primer vídeo de YouTube" · 1080×1350 ──
  {
    ...
    out:  `personal/2026/07/29-post-curiosidad-youtube/final.png`,
    w: 1080, h: 1350,
  },

  // ── 2026-07-27 · Carrusel "5 curiosidades de internet" · 7 slides 1080×1350 ──
  ...[1,2,3,4,5,6,7].map((n) => ({
    html: `personal/2026/07/27-carrusel-curiosidades/slide-${n}.html`,
    out:  `personal/2026/07/27-carrusel-curiosidades/slide-${n}.png`,
    w: 1080, h: 1350,
  })),
  ...
  ...["a","b","c","d"].map((v) => ({
    ...
    out:  `personal/2026/06/23-reel-demos-v2/cover-${v}.png`,
    w: 1080, h: 1920,
  })),
