...
¿Sabías que, antes de ser Google, el buscador se llamó BackRub? 🤔
...
#curiosidades #internet #google #paginasweb #webparaautonomos #pymes #tecnologia #datocurioso #historia
...
- Dato REAL y verificado: el buscador de Page y Brin (Stanford, 1996) se llamó BackRub; renombrado a Google en 1997, de «googol» (10^100). Fuentes: Seobility · computer-timeline · O'Reilly (Google Speaks).
- Serie de curiosidades. Remate en clave de HUMOR (nombres), distinto del remate "empieza imperfecto" del post de YouTube (29) para no repetir tono entre las dos curiosidades de la semana.
- Barras de búsqueda con lupa VERDE de marca (no colores de Google) para respetar la paleta; el contexto lo lee igual. Sin emojis en la pieza (los 🤔/👇 solo en caption/comentario). Kicker "en vivo" (pill translúcida).
- Cross-post FB: sí.
