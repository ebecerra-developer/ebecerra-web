...
const TARGETS = [
  {
    name: "reel-rescate",
    html: "_templates/reels/reel-rescate.html",
    out: "personal/reels/reel-rescate.mp4",
    poster: "personal/reels/reel-rescate-poster.png",
    duration: 18,
  },
  {
    name: "story-velocidad",
    html: "_templates/stories/story-velocidad.html",
    out: "personal/stories/story-velocidad.mp4",
    poster: "personal/stories/story-velocidad-poster.png",
    duration: 12,
  },
  {
    name: "reel-3puertas",
    html: "_templates/reels/reel-3puertas.html",
    out: "personal/reels/reel-3puertas.mp4",
    poster: "personal/reels/reel-3puertas-poster.png",
    duration: 18,
  },
  {
    name: "story-aeo",
    html: "_templates/stories/story-aeo.html",
    out: "personal/stories/story-aeo.mp4",
...
async function record(target) {
  ...
  const tmpDir = path.join(ROOT, `personal/_tmp-${target.name}`);
